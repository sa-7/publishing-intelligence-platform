        ...
        if (row.count === 0) {
            ...
            const journals = [
                ...
                ['Harvard Business Review', '0017-8012', 'Harvard Business Review Press', 'Business Strategy', 25.234,
                 ...
                 'Premier management magazine focusing on business strategy'],
                ...
                ['Strategic Management Journal', '0143-2095', 'Wiley', 'Business Strategy', 8.456,
                 ...
                 'Leading academic journal in strategic management'],
                ...
                ['Science', '0036-8075', 'AAAS', 'Multidisciplinary', 47.728,
                 'scientific research, innovation, technology, discovery',
                 'Leading journal for original scientific research'],
            ...
            // Generate sample subscriptions and browsing data
            setTimeout(() => {
                generateSampleData();
            }, 1000);
    ...
    try {
        ...
        if (openai) {
            try {
                ...
                aiResponse = generateEnhancedFallbackResponse(message, assistantType);
            }
        } else {
            aiResponse = generateEnhancedFallbackResponse(message, assistantType);
        }
...
async function generateRealDataResponse(message, assistantType) {
    ...
    try {
        ...
        if (lowerMessage.includes('trending') || lowerMessage.includes('popular') || lowerMessage.includes('author')) {
